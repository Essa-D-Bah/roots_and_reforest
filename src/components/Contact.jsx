export default function Contact() {
  return (
    <div className="pt-16">
      ...
      <h2 className="text-2xl text-center font-semibold">Call, Vist or Email us</h2>
        <div className="pt-4">
        <div className="flex gap-2 px-2 p-4 border rounded mb-8 ">
          <p className="text-xl font-semibold ">Email:</p>
          <p className="text-xl ">mmbye1156@gmail.com</p>
        </div> 
        <div className="flex gap-2 px-2 p-4 rounded border my-8 ">
          <p className="text-xl font-semibold ">Phone:</p>
          <p className="text-xl ">3945207</p>
        </div> 
        <div className="flex gap-2 px-2 py-4 border md:h-48 rounded my-8">
          <p className="text-xl font-semibold ">Address:</p>
          <div>
          <p className="text-xl ">Salagi Estate</p>
          <p className="text-xl ">Kombo North</p>
          <p className="text-xl ">The Gambia</p>
          </div>
        </div>  
        </div>
